// https://github.com/LinusU/decode-bmp/tree/master
...
export default function decodeBmp (source, { width: iconWidth = 0, height: iconHeight = 0, icon = false } = {}) {
  ...
  if (icon) {
    headerSize = data.readUint32LE(0, true)
    bitmapWidth = (data.readUint32LE(4, true) / 1) | 0
    bitmapHeight = (data.readUint32LE(8, true) / 2) | 0
    colorDepth = data.readUint16LE(14, true)
    colorCount = data.readUint32LE(32, true)
  } else {
    checkMagicBytes(data.readUint16LE(0, true))
    headerSize = 14 + data.readUint32LE(14, true)
    bitmapWidth = data.readUint32LE(18, true)
    bitmapHeight = data.readUint32LE(22, true)
    colorDepth = data.readUint16LE(28, true)
    colorCount = data.readUint32LE(46, true)
  }
